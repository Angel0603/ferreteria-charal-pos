      ...
      return (
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: "4px" }}>
            ...
            <p style={{ margin: "0 0 1px", fontSize: "9px" }}>
              Ferretería y Material Eléctrico
            </p>
            <p style={{ margin: "0 0 1px", fontSize: "9px" }}>El Charal</p>
            <p style={{ margin: "0 0 1px" }}>Tel: 7713444322</p>
            <p style={{ margin: 0 }}>{fechaHora}</p>
          </div>

          <p style={{ margin: "2px 0", textAlign: "center" }}>{sep}</p>

          <p style={{ margin: "1px 0" }}>
            Folio: <b>{folio}</b>
          </p>
          <p style={{ margin: "1px 0" }}>Cajero: {cajeroNombre}</p>
          <p style={{ margin: "1px 0" }}>
          ...
          {/* Productos */}
          {items.map((item) => (
            <div key={item.producto.id} style={{ marginBottom: "3px" }}>
              ...
              >
                ...
                <span>
                  <b>{formatCurrency(item.precio_unitario * item.cantidad)}</b>
                </span>
              </div>
              {item.descuento > 0 && (
            ...
            {metodoPago === "efectivo" &&
              ...
              efectivoRecibido > 0 && (
                <>
                  ...
                  >
                    <span>Cambio</span>
                    <span>{formatCurrency(cambio ?? 0)}</span>
                  </div>
                </>
              )}
          </div>
          ...
          >
            <p style={{ margin: "0 0 1px", fontWeight: "bold" }}>
              ¡Gracias por su compra!
            </p>
            <p style={{ margin: 0 }}>Conserve su ticket</p>
          </div>
        </div>
      );
    }
